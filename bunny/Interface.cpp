...
Interface::Interface(sf::RenderWindow& window)
{
	...
	button_menu.push_back(Menu(window, &menu_button_left, &menu_button_mid, &menu_button_right, &font_menu_button, button_menu.size(), "New game"));
	button_menu.push_back(Menu(window, &menu_button_left, &menu_button_mid, &menu_button_right, &font_menu_button, button_menu.size(), "Best Score"));
	button_menu.push_back(Menu(window, &menu_button_left, &menu_button_mid, &menu_button_right, &font_menu_button, button_menu.size(), "Options"));
	button_menu.push_back(Menu(window, &menu_button_left, &menu_button_mid, &menu_button_right, &font_menu_button, button_menu.size(), "Credits"));
	button_menu.push_back(Menu(window, &menu_button_left, &menu_button_mid, &menu_button_right, &font_menu_button, button_menu.size(), "Exit"));
